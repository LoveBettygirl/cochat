...
#include "MessageService/common/business_exception.h"
...
#define CALL_RPC_INTERFACE(type)                                                                               \
    ...
    catch (MessageService::BusinessException &e) {                                                            \
...
void MessageServiceRpcImpl::Forward(::google::protobuf::RpcController* controller,
                       const ::ForwardRequest* request,
                       ::ForwardResponse* response,
                       ::google::protobuf::Closure* done)
{
    CALL_RPC_INTERFACE(ForwardInterface);
}

void MessageServiceRpcImpl::ReadOffline(::google::protobuf::RpcController* controller,

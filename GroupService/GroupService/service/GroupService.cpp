...
void GroupServiceRpcImpl::GetGroupInfo(::google::protobuf::RpcController* controller,
                       const ::GetGroupInfoRequest* request,
                       ::GetGroupInfoResponse* response,
                       ::google::protobuf::Closure* done)
{
    CALL_RPC_INTERFACE(GetGroupInfoInterface);
}

void GroupServiceRpcImpl::GetUserGroups(::google::protobuf::RpcController* controller,
                       const ::GetUserGroupsRequest* request,
                       ::GetUserGroupsResponse* response,
                       ::google::protobuf::Closure* done)
{
    CALL_RPC_INTERFACE(GetUserGroupsInterface);
}

...
void testClient()
{
    ...
    ::CreateGroupRequest rpcReq;
    ::CreateGroupResponse rpcRes;

    std::cout << "Send to GroupService server " << addr->toString() << ", request body: " << rpcReq.ShortDebugString() << std::endl;
    stub.CreateGroup(&rpcController, &rpcReq, &rpcRes, NULL);
...
int main(int argc, char *argv[])
{
    if (argc != 2) {
        ...
        printf("./test_create_group_client GroupService.yml\n");
        return 0;
    }

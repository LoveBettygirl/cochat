/*************************************************************
 * test_get_group_info_client.cpp
...
void testClient()
{
    ...
    ::GetGroupInfoRequest rpcReq;
    ::GetGroupInfoResponse rpcRes;

    std::cout << "Send to GroupService server " << addr->toString() << ", request body: " << rpcReq.ShortDebugString() << std::endl;
    stub.GetGroupInfo(&rpcController, &rpcReq, &rpcRes, NULL);
...
int main(int argc, char *argv[])
{
    if (argc != 2) {
        ...
        printf("./test_get_group_info_client GroupService.yml\n");
        return 0;
    }

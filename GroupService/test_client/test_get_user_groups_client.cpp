/*************************************************************
 * test_get_user_groups_client.cpp
...
void testClient()
{
    ...
    ::GetUserGroupsRequest rpcReq;
    ::GetUserGroupsResponse rpcRes;

    std::cout << "Send to GroupService server " << addr->toString() << ", request body: " << rpcReq.ShortDebugString() << std::endl;
    stub.GetUserGroups(&rpcController, &rpcReq, &rpcRes, NULL);
...
int main(int argc, char *argv[])
{
    if (argc != 2) {
        ...
        printf("./test_get_user_groups_client GroupService.yml\n");
        return 0;
    }

/*************************************************************
 * test_read_offline_message_client.cpp
...
void testClient()
{
    ...
    ::ReadOfflineMessageRequest rpcReq;
    ::ReadOfflineMessageResponse rpcRes;

    std::cout << "Send to ChatService server " << addr->toString() << ", request body: " << rpcReq.ShortDebugString() << std::endl;
    stub.ReadOfflineMessage(&rpcController, &rpcReq, &rpcRes, NULL);
...
int main(int argc, char *argv[])
{
    if (argc != 2) {
        ...
        printf("./test_read_offline_message_client ChatService.yml\n");
        return 0;
    }

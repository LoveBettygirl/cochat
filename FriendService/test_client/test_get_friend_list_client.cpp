/*************************************************************
 * test_get_friend_list_client.cpp
...
void testClient()
{
    ...
    ::FriendListRequest rpcReq;
    ::FriendListResponse rpcRes;

    std::cout << "Send to FriendService server " << addr->toString() << ", request body: " << rpcReq.ShortDebugString() << std::endl;
    stub.GetFriendList(&rpcController, &rpcReq, &rpcRes, NULL);
...
int main(int argc, char *argv[])
{
    if (argc != 2) {
        ...
        printf("./test_get_friend_list_client FriendService.yml\n");
        return 0;
    }

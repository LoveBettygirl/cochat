...
void testClient()
{
    ...
    ::DeleteFriendRequest rpcReq;
    ::DeleteFriendResponse rpcRes;

    std::cout << "Send to FriendService server " << addr->toString() << ", request body: " << rpcReq.ShortDebugString() << std::endl;
    stub.DeleteFriend(&rpcController, &rpcReq, &rpcRes, NULL);
...
int main(int argc, char *argv[])
{
    if (argc != 2) {
        ...
        printf("./test_delete_friend_client FriendService.yml\n");
        return 0;
    }

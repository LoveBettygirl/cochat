...
void testClient()
{
    ...
    ::WriteOfflineRequest rpcReq;
    ::WriteOfflineResponse rpcRes;

    std::cout << "Send to OfflineService server " << addr->toString() << ", request body: " << rpcReq.ShortDebugString() << std::endl;
    stub.WriteOffline(&rpcController, &rpcReq, &rpcRes, NULL);
...
int main(int argc, char *argv[])
{
    if (argc != 2) {
        ...
        printf("./test_write_offline_client OfflineService.yml\n");
        return 0;
    }
